...
public class KthPermutationSequence {
     ...
     *
     * In this second step, permutations of 2 numbers has only 2 possibilities, meaning each of the three permutations listed above a has two possibilities,
    ...
    public String getPermutation(int n, int k) {
        ...
        for (int i = 1; i <= n; i++) {
            int index = factorial[n - i] == 0 ? 0 : (int) (k / factorial[n - i]);
